    ...
    return (
        <section className='flex flex-col items-center justify-center mt-32'>
            ...
            <div className='mt-12 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3'>
                {reviews.map((item) => (
                    <div key={item.id} className='w-full max-w-88 space-y-4 rounded-md border border-gray-200 bg-white p-5 text-gray-500 transition-all duration-300 hover:-translate-y-1'>
