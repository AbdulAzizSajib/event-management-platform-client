...
import { CalendarDays, Eye, EyeOff, Lock, Mail, UserIcon } from 'lucide-react';
        ...
        <div className="w-full max-w-md">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
                ...
                >
                    <form.Field
                        name="name"
                        validators={{ onChange: signupZodSchema.shape.name }}
                    >
                        {(field) => (
                            <AppField
                                field={field}
                                ...
                                icon={<UserIcon className="size-5 text-gray-400" />}
                            />
                        )}
                    </form.Field>
                    ...
                    <form.Field
                        name="email"
                        validators={{ onChange: signupZodSchema.shape.email }}
                    >
                        {(field) => (
                            <AppField
                                field={field}
                    ...
                    <form.Field
                        name="password"
                        validators={{ onChange: signupZodSchema.shape.password }}
                    >
                        {(field) => (
                            <AppField
                                field={field}
