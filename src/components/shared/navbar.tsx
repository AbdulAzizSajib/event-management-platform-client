    ...
    const links: NavLink[] = [
        ...
        { name: 'Events', href: '/events' },
        {
            ...
            subLinks: [
                ...
                { name: 'Create Event', href: '/dashboard', icon: PlusCircle, description: 'Host your own event' },
                { name: 'My Tickets', href: '/dashboard', icon: Ticket, description: 'View your registrations' },
                { name: 'Saved Events', href: '/dashboard', icon: Heart, description: 'Your bookmarked events' },
                { name: 'My Reviews', href: '/dashboard', icon: Star, description: "Events you've reviewed" },
            ],
        },
